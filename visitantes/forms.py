...
class VisitanteForm(forms.ModelForm):
    class Meta:
        ...
        error_messages = {
            "nome_completo": {
                "required": "O nome completo do visitante é obrigatótio para o registro"
            },
            "cpf": {
                "required": "O CPF do visitante é obrigatótio para o registro"
            },
            "data_nascimento": {
                "required": "A data de nascimento do visitante é obrigatótio para o registro",
